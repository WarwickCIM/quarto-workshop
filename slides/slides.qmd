...
1.  Pick a case you would like to develop during this workshop
    1.  The issue describes the steps and deliverables
2.  Create groups of people who want to work on the same case
...
## 1. Pick your case and create a group!

1.  Choose one of the [provided cases](https://github.com/WarwickCIM/quarto-workshop/labels/cases) (or create a new one!) [![](images/task_list.png)](https://github.com/WarwickCIM/quarto-workshop/labels/cases)
    1.  Each case has a description of what you need to do, outputs, template and reference.
...
1.  Assign a case to yourself to show interest
...
Create a mermaid diagram for the process? (here or elsewhere)
