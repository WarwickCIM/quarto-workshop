...
[cagatay.turkay\@warwick.ac.uk](mailto:cagatay.turkay@warwick.ac.uk){.email}
...
2.  Introduction to Quarto (15'): *2:00 -- 2:15*
3.  Setting the environment (10'): *2:15 -- 2:25*
4.  Tasks presentation and creation of groups (15'): *2:25 -- 2:40*
    1.  Tasks' presentation
    2.  Creation of groups
5.  Work Group and documentation (20'): *2:40 -- 3:00*
6.  Break (20')[^2]: *3:00 -- 3:20*
7.  Work Group and documentation (continuation) (55') *3:20 -- 4:15*
8.  Discussion (35'): *4:15 -- 4:50*

[^2]: There will be refreshments on the Ground Floor Foyer from 3:00 to 3:20

# Quarto {background-color="#2780e3"}

## Preamble

* Everyone agrees on the value for Literate programming in Data Science
* Each programming language has followed a different approach re notebooks

::: columns
::: {.column width="50%"}
### R: Rmarkdown

* "Markdown on steroids" that generates one or more outputs
  - Code blocks are configurable (size, display, labels...)
* Other packages:
  - bookdown, blogdown, xaringan, revealjs...
* Works with R only (and python via [`{reticulate}`](https://rstudio.github.io/reticulate/index.html))
:::
...
-   Rmarkdown's Next generation[^3]
-   Actively maintained (weekly releases)
-   Relatively new (first development pre-release from January 2021)
