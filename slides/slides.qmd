...
We are just quarto users who want to share our progress and engage with other users in a co-creation process with an attitude of _healthy skepticism_.

. . .

**About the session**

This is not (just) a talk about quarto. Others have done it very well before[^others].
We will be presenting quarto's main claims and seeing how it compares to other alternatives.

[^others]: See references' section
...
-   [RStudio's 2-hour workshop on quarto](https://www.youtube.com/watch?v=yvi5uXQMvu4)
