...
A brief overview to quarto (thats why we are here, right?)
...
[![](images/gallery_slides_mock_workshop.png)](https://jthomasmock.github.io/quarto-2hr-webinar/materials/01-intro-quarto.html)

### Projects

Such as websites, blogs, wikis... (several `*.qmd` files + `_quarto.yml` with config)
...
<small>Documentation here <https://quarto.org/docs/interactive/widgets/htmlwidgets.html></small>
...
<small>Documentation here: <https://quarto.org/docs/interactive/widgets/jupyter.html></small>

### shiny

[![Diamonds' explorer](images/gallery_shiny.png)](https://jjallaire.shinyapps.io/diamonds-explorer/)

Documentation here: <https://quarto.org/docs/interactive/shiny/>

### Observable

[![Penguin's explorer](images/gallery_observable_penguins.png)](https://quarto.org/docs/interactive/ojs/)

Documentation here: <https://quarto.org/docs/interactive/ojs/>

:::


## Key features {background-color="rgb(236, 248, 232)"}
